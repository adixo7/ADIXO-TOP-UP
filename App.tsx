                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        {selectedGame.packages.map(pkg => {
                          ...
                          const themes: Record<number, EbTheme> = {
                            ...
                            14: { gradient: 'from-blue-950/70 to-zinc-900', border: 'border-blue-500/70', glow: 'shadow-[0_0_28px_rgba(59,130,246,0.35)]', accent: 'text-blue-400', accentHex: 'rgba(59,130,246,0.12)', badgeBg: 'bg-blue-500', badge: 'HOT', name: 'HYPER', chance: '75%', iconBg: 'bg-blue-900/60 border-blue-500/50', shimmer: false, topLine: true, topLineColor: 'from-blue-600/70 via-blue-400/50 to-blue-600/70', sparkle: false, stockOut: true },
