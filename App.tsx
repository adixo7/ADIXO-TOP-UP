                  ...
                  >
                     <div className="aspect-video overflow-hidden bg-[#17141d] relative flex items-center justify-center">
                      ...
                      />
                       ...
                       <div className="absolute bottom-2 md:bottom-4 left-2 md:left-4 right-2 md:right-4 rounded-xl bg-[#0c0c0e]/55 backdrop-blur-sm border border-white/10 px-2 py-1.5 md:px-3 md:py-2 shadow-lg">
                            ...
                            {groupedPackages[category].map(pkg => {
                              ...
                              >
                                ...
                                <div className="flex items-center gap-2 shrink-0 relative z-10">
                                  <span className={`text-sm md:text-lg font-black tracking-tighter transition-colors ${
                                    selectedPackage?.id === pkg.id ? 'text-white'
                        ...
                        <div className="relative flex items-center gap-3 p-4">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-white font-black text-sm uppercase italic tracking-tight leading-tight truncate">
                              {selectedPackage.id === 'ff-likes-mega' ? selectedPackage.unit : `${selectedPackage.amount} ${selectedPackage.unit}`}
                            </p>
                          </div>
              ...
              {transactions.map(trx => (
                <div key={trx.id} className="relative bg-[#0c0c0e] border border-zinc-800/50 p-4 md:p-6 rounded-2xl flex flex-col gap-4 group hover:border-orange-500/30 transition-all duration-300">
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="text-right shrink-0">
                      <p className="gaming-font text-2xl font-black text-white tracking-tighter leading-none mb-2">${Number(trx.price).toFixed(2)}</p>
