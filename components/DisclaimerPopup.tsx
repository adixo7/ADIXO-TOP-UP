        ...
        <div className="text-center mb-6">
          ...
          <div className="space-y-3 text-zinc-400 text-xs font-medium leading-relaxed">
            ...
            <div className="bg-zinc-900/50 border border-zinc-800 p-3 rounded-xl text-[10px] space-y-1 text-left">
              <p className="text-[9px] uppercase tracking-widest text-zinc-500 font-black mb-2 text-center">{t('disclaimer.whatWeOffer')}</p>
              <p><i className="fas fa-gem text-orange-500 mr-2"></i>{t('disclaimer.offer1')}</p>
              <p><i className="fas fa-robot text-orange-500 mr-2"></i>{t('disclaimer.offer2')}</p>
              <p><i className="fas fa-desktop text-orange-500 mr-2"></i>{t('disclaimer.offer3')}</p>
            </div>

            <div className="pt-2 space-y-2">
              <p className="text-[9px] uppercase tracking-widest text-zinc-500 font-black">{t('disclaimer.supportContact')}</p>
              <p className="text-[10px] text-zinc-400">{t('disclaimer.supportDesc')}</p>
              <div className="flex flex-col gap-1.5">
                ...
                <p className="text-[9px] text-zinc-500 leading-none">{t('disclaimer.updatesLabel')}</p>
                ...
                <p className="text-[9px] text-zinc-500 leading-none">{t('disclaimer.orderLabel')}</p>
              </div>
            </div>
          </div>
        </div>
