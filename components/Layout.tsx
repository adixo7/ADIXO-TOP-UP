...
const Layout: React.FC<LayoutProps> = ({
  ...
  const BellButton = (
    <div className="relative" ref={bellRef}>
      ...
      {isBellOpen && (
        <div
          className="fixed sm:absolute left-1/2 sm:left-auto -translate-x-1/2 sm:translate-x-0 top-20 sm:top-auto sm:right-0 sm:mt-3 w-72 sm:w-80 md:w-96 rounded-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200 z-[100]"
          style={{
