...
export const GAMES: Game[] = [
  ...
  },
  {
    ...
    packages: [
      { id: 'bs-vsp', amount: 1, unit: 'Value Season Pass', price: 120, currency: 'BDT', category: 'MEMBERSHIP' },
      { id: 'bs-lbw', amount: 1, unit: 'Lucky Bag Week', price: 125, currency: 'BDT', category: 'MEMBERSHIP' },
      { id: 'bs-vpo', amount: 1, unit: 'Valor Pre-Order Offer', price: 220, currency: 'BDT', category: 'MEMBERSHIP' },
      { id: 'bs-rtr', amount: 1, unit: 'Rags to Riches', price: 215, currency: 'BDT', category: 'MEMBERSHIP' },
      { id: 'bs-uslc', amount: 1, unit: 'Ultra Skin Lucky Chest', price: 60, currency: 'BDT', category: 'MEMBERSHIP' },
      { id: 'bs-spe', amount: 1, unit: 'Strike Pass Elite', price: 460, currency: 'BDT', category: 'MEMBERSHIP' },
      { id: 'bs-spp', amount: 1, unit: 'Strike Pass Premium', price: 1030, currency: 'BDT', category: 'MEMBERSHIP' },
      
      { id: 'bs-lup', amount: 1, unit: 'Level Up Pass', price: 240, currency: 'BDT', category: 'LEVEL UP PASS' },

      { id: 'bs-51', amount: 51, unit: 'Golds', price: 55, currency: 'BDT', category: 'DIAMOND TOPUP' },
      { id: 'bs-105', amount: 105, unit: 'Golds', price: 100, currency: 'BDT', category: 'DIAMOND TOPUP' },
      { id: 'bs-320', amount: 320, unit: 'Golds', price: 340, currency: 'BDT', category: 'DIAMOND TOPUP' },
      { id: 'bs-540', amount: 540, unit: 'Golds', price: 495, currency: 'BDT', category: 'DIAMOND TOPUP' },
      { id: 'bs-1100', amount: 1100, unit: 'Golds', price: 985, currency: 'BDT', category: 'DIAMOND TOPUP' },
      { id: 'bs-2260', amount: 2260, unit: 'Golds', price: 1970, currency: 'BDT', category: 'DIAMOND TOPUP' },
      { id: 'bs-5800', amount: 5800, unit: 'Golds', price: 4930, currency: 'BDT', category: 'DIAMOND TOPUP' },
    ]
  },
  {
    id: 'codm',
