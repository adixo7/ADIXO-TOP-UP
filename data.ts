...
export const GAMES: Game[] = [
  ...
  },
  {
    ...
    packages: [
      ...
      { id: 'mystery-epic', amount: 4, unit: 'EPIC MYSTERY BOX', price: 504, currency: 'BDT', category: 'MYSTERY BOX', description: '4 BOTS | 150K - 1.2M GLORY | 100% SAFE', image: '/images/mystery/boxes.png' },
      { id: 'mystery-super', amount: 4, unit: 'SUPER MYSTERY BOX', price: 1008, currency: 'BDT', category: 'MYSTERY BOX', description: '4 BOTS | 200K - 3.4M GLORY | 100% SAFE', image: '/images/mystery/boxes.png' },
  ...
  },
  {
    ...
    packages: [
      { id: 'lu-1-30',  amount: 30,  unit: 'Level 1 → 30',   price: 600,   currency: 'BDT', category: 'LEVEL UP SERVICE', description: 'Boost from Level 1 to 30' },
      ...
      { id: 'lu-90-100',amount: 100, unit: 'Level 90 → 100 (SUPREME)', price: 55000, currency: 'BDT', category: 'LEVEL UP SERVICE', description: 'Supreme boost from Level 90 to 100', isPopular: true }
    ]
  },
  {
    id: 'event-bypass',
  ...
  },
  {
    ...
    packages: [
      { id: 'guild-adixo-3102234605', amount: 1, unit: 'GUILD', price: 950, currency: 'BDT', category: 'GUILD SHOP', description: 'Level 7 Guild · 50 Player Space · BD Server', isPopular: true, image: '/images/guild-adixo-3102234605.jpg', level: 7, playerSpace: 50, server: 'BD', guildId: '3102234605' },
  ...
  },
  {
    ...
    packages: [
      ...
      { id: 'ff-likes-mega', amount: 0, unit: 'Likes (∞ Days)', price: 1499, oldPrice: 3000, currency: 'BDT', category: 'FF LIKES', description: '450 Likes/Day × ∞ Days = NO LIMITS Total Likes' }
    ]
  },
  {
    id: 'pc-games',
    name: 'PC Games',
    category: 'PC Games',
    image: '/images/gta-6-cover.avif',
    banner: '/images/gta-6-cover.avif',
    idPlaceholder: 'Steam/Epic Account Email',
    description: 'Grand Theft Auto VI Premium Edition for ৳9,999.',
    packages: [
