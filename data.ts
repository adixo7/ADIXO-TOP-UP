...
export const GAMES: Game[] = [
  ...
  },
  {
    ...
    packages: [
      { id: 'bs-vsp', amount: 1, unit: 'Value Season Pass', price: 122, currency: 'BDT', category: 'MEMBERSHIP' },
      { id: 'bs-lbw', amount: 1, unit: 'Lucky Bag Week', price: 127, currency: 'BDT', category: 'MEMBERSHIP' },
      { id: 'bs-vpo', amount: 1, unit: 'Valor Pre-Order Offer', price: 223, currency: 'BDT', category: 'MEMBERSHIP' },
      { id: 'bs-rtr', amount: 1, unit: 'Rags to Riches', price: 218, currency: 'BDT', category: 'MEMBERSHIP' },
      { id: 'bs-uslc', amount: 1, unit: 'Ultra Skin Lucky Chest', price: 61, currency: 'BDT', category: 'MEMBERSHIP' },
      { id: 'bs-spe', amount: 1, unit: 'Strike Pass Elite', price: 465, currency: 'BDT', category: 'MEMBERSHIP' },
      { id: 'bs-spp', amount: 1, unit: 'Strike Pass Premium', price: 1041, currency: 'BDT', category: 'MEMBERSHIP' },
      
      { id: 'bs-lup', amount: 1, unit: 'Level Up Pass', price: 240, currency: 'BDT', category: 'LEVEL UP PASS' },

      { id: 'bs-51', amount: 51, unit: 'Golds', price: 56, currency: 'BDT', category: 'DIAMOND TOPUP' },
      { id: 'bs-105', amount: 105, unit: 'Golds', price: 101, currency: 'BDT', category: 'DIAMOND TOPUP' },
      { id: 'bs-320', amount: 320, unit: 'Golds', price: 344, currency: 'BDT', category: 'DIAMOND TOPUP' },
      { id: 'bs-540', amount: 540, unit: 'Golds', price: 500, currency: 'BDT', category: 'DIAMOND TOPUP' },
      { id: 'bs-1100', amount: 1100, unit: 'Golds', price: 995, currency: 'BDT', category: 'DIAMOND TOPUP' },
      { id: 'bs-2260', amount: 2260, unit: 'Golds', price: 1990, currency: 'BDT', category: 'DIAMOND TOPUP' },
      { id: 'bs-5800', amount: 5800, unit: 'Golds', price: 4980, currency: 'BDT', category: 'DIAMOND TOPUP' },
    ]
  },
  {
    id: 'codm',
  ...
  },
  {
    ...
    packages: [
      ...
      { id: 'mystery-basic', amount: 4, unit: 'BASIC MYSTERY BOX', price: 2, currency: 'USD', category: 'MYSTERY BOX', description: '4 Bots | Glory: 50k - 370k | Instant Delivery', image: '/images/mystery-box-basic.png' },
      { id: 'mystery-epic', amount: 4, unit: 'EPIC MYSTERY BOX', price: 4, currency: 'USD', category: 'MYSTERY BOX', description: '4 Bots | Glory: 350k - 1.2M | Instant Delivery', image: '/images/mystery-box-epic.png' },
      { id: 'mystery-super', amount: 4, unit: 'SUPER MYSTERY BOX', price: 8, currency: 'USD', category: 'MYSTERY BOX', description: '4 Bots | Glory: 1.2M - 3.4M | Instant Delivery', image: '/images/mystery-box-super.png' }
    ]
  },
  {
    id: 'pc-games',
