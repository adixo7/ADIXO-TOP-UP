...
export const GAMES: Game[] = [
  ...
  },
  {
    ...
    packages: [
      { id: 'bs-vsp', amount: 1, unit: 'Value Season Pass', price: 126, currency: 'BDT', category: 'MEMBERSHIP' },
      { id: 'bs-lbw', amount: 1, unit: 'Lucky Bag Week', price: 132, currency: 'BDT', category: 'MEMBERSHIP' },
      { id: 'bs-vpo', amount: 1, unit: 'Valor Pre-Order Offer', price: 231, currency: 'BDT', category: 'MEMBERSHIP' },
      { id: 'bs-rtr', amount: 1, unit: 'Rags to Riches', price: 226, currency: 'BDT', category: 'MEMBERSHIP' },
      { id: 'bs-uslc', amount: 1, unit: 'Ultra Skin Lucky Chest', price: 63, currency: 'BDT', category: 'MEMBERSHIP' },
      { id: 'bs-spe', amount: 1, unit: 'Strike Pass Elite', price: 483, currency: 'BDT', category: 'MEMBERSHIP' },
      { id: 'bs-spp', amount: 1, unit: 'Strike Pass Premium', price: 1082, currency: 'BDT', category: 'MEMBERSHIP' },
      
      { id: 'bs-lup', amount: 1, unit: 'Level Up Pass', price: 240, currency: 'BDT', category: 'LEVEL UP PASS' },

      { id: 'bs-51', amount: 51, unit: 'Golds', price: 58, currency: 'BDT', category: 'DIAMOND TOPUP' },
      { id: 'bs-105', amount: 105, unit: 'Golds', price: 105, currency: 'BDT', category: 'DIAMOND TOPUP' },
      { id: 'bs-320', amount: 320, unit: 'Golds', price: 357, currency: 'BDT', category: 'DIAMOND TOPUP' },
      { id: 'bs-540', amount: 540, unit: 'Golds', price: 520, currency: 'BDT', category: 'DIAMOND TOPUP' },
      { id: 'bs-1100', amount: 1100, unit: 'Golds', price: 1035, currency: 'BDT', category: 'DIAMOND TOPUP' },
      { id: 'bs-2260', amount: 2260, unit: 'Golds', price: 2069, currency: 'BDT', category: 'DIAMOND TOPUP' },
      { id: 'bs-5800', amount: 5800, unit: 'Golds', price: 5177, currency: 'BDT', category: 'DIAMOND TOPUP' },
    ]
  },
  {
    id: 'codm',
