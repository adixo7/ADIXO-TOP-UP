...
export const GAMES: Game[] = [
  ...
  },
  {
    ...
    packages: [
      ...
      { id: 'mystery-basic', amount: 4, unit: 'BASIC MYSTERY BOX', price: 2, currency: 'USD', category: 'MYSTERY BOX', description: '100% SAFE', image: '/images/mystery-box-basic.png' },
      { id: 'mystery-epic', amount: 4, unit: 'EPIC MYSTERY BOX', price: 4, currency: 'USD', category: 'MYSTERY BOX', description: '100% SAFE', image: '/images/mystery-box-epic.png' },
      { id: 'mystery-super', amount: 4, unit: 'SUPER MYSTERY BOX', price: 8, currency: 'USD', category: 'MYSTERY BOX', description: '100% SAFE', image: '/images/mystery-box-super.png' }
    ]
  },
  {
    id: 'pc-games',
